...
#################################################
# 기본 데이터 타입
# 1. 숫자형(numeric) : 숫자로 되어 있고 정수형과 실수형을 의미. "L"기호를 이용하여 정수, 실수를 구분 ex) 100L #정수형 숫자(L이 붙어있어야) 
...
# 데이터 타입을 다른 데이터 타입으로 바꿀 수 있어요 ( type casting )
var1 <- 3.14159265358979
var2 <- 0
var3 <- "3.1415"
var4 <- "Hello"

#데이터 타입을 변경할 때는 as게열의 함수를 이용해요
as.character(var1)    # "3.1415..."
as.integer(var1)    # 3
as.logical(var2)    # FALSE #(0은 FALSE. 0을 제외하고는 TRUE)
